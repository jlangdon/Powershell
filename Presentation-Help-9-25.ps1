...
# PowerShell V 3.0 - September 2012
...
cls ; get-help *service*   #Wildcard search with * asterisk. Find cmdlets with service in the name



cls ; get-help g*service* #Wildcard before * to search for all "Get" verbs with Service noun.
...
cls ; get-help   # get cmdlets that work with Active Directory 
